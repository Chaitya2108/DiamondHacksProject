            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, amqplib_1.default.connect(url, {
                            credentials: amqplib_1.default.credentials.plain(user, pass),
                        })];
                case 1:
                    connection = _a.sent();
                ...
                case 2:
                    channel = _a.sent();
                    return [4 /*yield*/, channel.assertQueue("jobs", { durable: false })];
                case 3:
                    _a.sent();
                    channel.prefetch(1);
                    console.log(" [*] Waiting for messages jobs");
                    active = 0;
                    channel.consume("jobs", function (msg) { return __awaiter(_this, void 0, void 0, function () {
                        var res;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, handle(JSON.parse(msg.content.toString()))];
                                case 1:
                                    res = _a.sent();
...
var jsonSchema = zod_1.z.object({
    id: zod_1.z.string(),
    lang: zod_1.z.enum(["js", "py"]),
    boilerplate: zod_1.z.string(),
    tests: zod_1.z.array(zod_1.z.object({
        expected: zod_1.z.string(),
        actual: zod_1.z.string(),
    })),
    submission: zod_1.z.string(),
});
function handle(json) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log(" [x] Received %s", json.id);
            return [2 /*return*/];
        });
    });
}
